...
func (a *AccessAndMobilitySubscriptionDataRetrievalApiService) GetAmData(ctx context.Context,
	supi string, localVarOptionals *GetAmDataParamOpts) (models.AccessAndMobilitySubscriptionData, *http.Response, error) {
	var (
