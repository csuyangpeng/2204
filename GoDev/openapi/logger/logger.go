...
func init() {
	...
	free5gcLogHook, err := NewFileHook(Free5gcLogFile, os.O_CREATE|os.O_APPEND|os.O_RDWR, 0666)
	if err == nil {
		log.Hooks.Add(free5gcLogHook)
	}

	selfLogHook, err := NewFileHook(LibLogDir+"openapi.log", os.O_CREATE|os.O_APPEND|os.O_RDWR, 0666)
	if err == nil {
