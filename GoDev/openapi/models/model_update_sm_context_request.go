...
func (p UpdateSmContextRequest) String() string {
	return fmt.Sprintf("msg.ReqData.JsonData: ", p.JsonData,
		", msg.ReqData.BinaryDataN2SmInformation: ", p.BinaryDataN2SmInformation,
		", msg.ReqData.BinaryDataN1SmMessage: ", p.BinaryDataN1SmMessage)
}
